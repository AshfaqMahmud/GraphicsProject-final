...
public:
    ...
    void MoveToPosition(glm::vec3 targetPosition)
    {
        Position = targetPosition;
        GetViewMatrix();
        updateCameraVectors(); // Update the camera vectors after changing the position
    }

    void MoveLookAtPosition(glm::vec3 targetPosition)
    {
